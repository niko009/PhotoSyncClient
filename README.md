...
> **Status:** 0.6.0-beta under active development. This repository is the canonical source for both the Android client and the server.
...
Update **both** server and Android together for 0.6.0-beta because folder sharing editing adds an owner-only read endpoint for the persisted ACL state.
